...
Gui.AppearanceUtilities = class
{
	constructor(initGameUserInterface, initGameScreenProperties, initAppearanceUtilities)
	{
		...
		this.textLabelAppearanceLayer = this.gameUserInterface.AddTextLabel(1130, 135, 90, 25, "Layer", "#000000", null, "text", this.appearanceLayerOverrideScreens, true)
		this.textFieldAppearanceLayer = this.gameUserInterface.AddTextField(1130, 170, 90, 25, 24, 3, "0", this.appearanceLayerOverrideScreens, true)
